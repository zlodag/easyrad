...
class JAB {
    ...
    RegisterEvent(eventName, handler:=0) {
        ...
        EventHandlerMethodName := "__Handle" (this.HasMethod("__Handle" eventName "Event") ? eventName : "") "Event"
    ...
    __HandlePropertyActiveDescendentChangeEvent(handler, vmID, event, source, oldActiveDescendent, newActiveDescendent) {
        ToolTip "vmID:" vmID ", event:" event ", source:" source ", oldActiveDescendent:" oldActiveDescendent ", newActiveDescendent:" newActiveDescendent

        ; handler(JAB.JavaEvent(vmID, event, this), JAB.JavaAccessibleContext(vmID, source, this), JAB.JavaAccessibleContext(vmID, oldActiveDescendent, this), JAB.JavaAccessibleContext(vmID, newActiveDescendent, this))
